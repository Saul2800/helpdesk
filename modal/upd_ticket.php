                ...
                <div class="modal-body">
                    <form action="testmailer.php"class="form-horizontal form-label-left input_mask" method="post" id="upd" name="upd">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9 col-sm-9 col-xs-12">
                              <input maxlength="30" type="text" name="title" class="form-control" placeholder="Titulo" id="mod_title" required>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Proceso Electoral
                            </label>
                            <div class="col-md-9 col-sm-9 col-xs-12">
