        ...
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel"> Editar Proceso Electoral</h4>
                </div>
                    ...
                    <form class="form-horizontal form-label-left input_mask" method="post" id="upd" name="upd">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9 col-sm-9 col-xs-12">
                              <input type="text" id="mod_name" maxlength="30" required name="mod_name" class="form-control" placeholder="Nombre">
                            </div>
                        </div>
                        <div class="form-group">
