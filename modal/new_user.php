            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="testmailer.php" class="form-horizontal form-label-left input_mask" id="add_user" name="add_user">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                            <input name="TELEFONO" pattern="[0-9]{9,9}" maxlength="9" title="Haz coincidir el formato de 9 digitos para el teléfono." required type="text" class="form-control" placeholder="Teléfono">
                        </div>
